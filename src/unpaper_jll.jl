...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import unpaper_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("d52248c9-e08a-51c2-9066-05d0bf3e6245"))
platforms = [Pkg.Artifacts.unpack_platform(e, "unpaper", artifacts_toml) for e in artifacts["unpaper"]]
...
if best_platform === nothing
    @debug("Unable to load unpaper; unsupported platform $(triplet(platform_key_abi()))")
else
